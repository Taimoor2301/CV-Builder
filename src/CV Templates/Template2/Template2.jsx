	...
	return (
		<div className='w-[210mm] min-h-[297mm] relative overflow-hidden p-6 grid grid-cols-2 gap-3 border'>
			<section className='col-span-full pl-4'>
				<div className='py-3'>
					<h1 className='text-4xl'>Milan Sarzik</h1>
					<h1>Software Engineer</h1>
				</div>
				<div className='flex justify-between items-center text-xs'>
					<div>
						<div className='font-semibold'>
							Phone Number: <span className='font-medium'>(555) 555-555</span>
						</div>
						<div className='font-semibold'>
							Email Address: <span className='font-medium'>example@example.com</span>
						</div>
						<div className='font-semibold'>
							Location: <span className='font-medium'>Islamabad</span>
						</div>
						<div className='font-semibold'>
			...
			<section className='col-span-1 flex flex-col gap-7'>
				<div className='flex flex-col gap-2'>
					<IconHeading text='Profile' Icon={IoPerson} />
					<p className='text-[13px] tracking-wide font-medium pl-5'>
						Lorem ipsum dolor sit, amet consectetur adipisicing elit. Ut architecto mollitia vitae temporibus neque dolore suscipit facilis nisi iusto
						nobis! Harum vero, illo dolorum iste possimus hic architecto ab eum blanditiis, quis quibusdam. Fugiat id placeat necessitatibus, sequi
						veritatis nostrum vitae beatae minima architecto inventore? Adipisci eveniet laborum incidunt consequuntur!
					</p>
				</div>

				<div className='flex flex-col gap-2'>
					<IconHeading text='Skills' Icon={ImLab} />
				...
				<div>
					<IconHeading text='Education' Icon={HiAcademicCap} />
			...
			<section className='col-span-1 flex flex-col gap-7'>
				...
				<div>
					<IconHeading text='Work History' variant='dark' Icon={MdOutlineWork} />
					<div className='flex flex-col gap-5 pt-5 pl-5'>
				...
				<div>
					<IconHeading text='Hobbies' variant='dark' Icon={MdOutlineInterests} />
					<div className='flex items-center py-5 font-medium gap-6 flex-wrap px-5'>
						{hobbies.map((hobbie) => (
							<span className='text-[13px]' key={hobbie}>
								{hobbie}
							</span>
						))}
					</div>
		...
		<div className='grid grid-cols-2'>
			...
			<div className='col-span-1 flex items-center'>
				<div className='w-full h-[1px] bg-gray-400 flex items-center'>
					<div className='h-[4px] bg-yellow-300' style={{ width: width }}></div>
...
const Work = ({ startDate, endDate, role, company, detail, location }) => {
	return (
		<div className='flex flex-col gap-0.5'>
			<span className='flex items-center gap-2'>
				<MdDateRange />
