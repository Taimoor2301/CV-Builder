...
const Template1 = () => {
	return (
		<>
			{/* cv 1  */}
			<div className='w-[210mm] min-h-[297mm] relative overflow-hidden p-6'>
				{/* backgrounds  */}
				<div className='absolute inset-0 bg-yellow-300 z-[-1]'></div>
				<div className='absolute inset-0 bg-yellow-600 left-[30%] z-[-1]'></div>

				<main className='bg-white w-full h-full p-5 grid grid-cols-3'>
					<section className='flex items-end h-[200px] col-span-full'>
						...
						<div className='flex flex-col gap-2 items-start h-full pt-10'>
							<h1 className='uppercase font-bold text-4xl tracking-wider'>Lou alvarez</h1>
							<h1 className='font-medium tracking-wider text-xl'>Web Developer</h1>
					...
					<section className='col-span-1 flex flex-col gap-6'>
						...
						<div className='flex flex-col gap-3'>
							...
							<div className='flex flex-col gap-2 text-xs'>
								{languages.map((lang) => (
									<div className='font-semibold' key={lang.name}>
						...
						<div className='flex flex-col gap-3'>
							...
							<ul className='flex flex-col gap-1 text-xs pl-5'>
								{hobbies.map((hobbie) => (
									<li className='font-medium list-disc' key={hobbie}>
										{hobbie}
									</li>
								))}
							</ul>
						...
						<div className='flex flex-col gap-4 pl-8'>
							<div className='flex flex-col gap-2'>
								...
								<p className='text-sm font-medium'>
									Lorem ipsum dolor sit amet consectetur adipisicing elit. Ratione illum ad architecto blanditiis vitae quia rerum velit quis vel
									saepe cum numquam facilis suscipit error aperiam enim similique nihil, beatae eos officiis quaerat. Sequi expedita ipsum enim rerum
									nobis minima doloremque voluptatum, non delectus repudiandae, eos vitae quisquam autem? Quisquam.
								</p>
							</div>
...
const Work = ({ startDate, endDate, company, role, location, detail }) => {
	return (
